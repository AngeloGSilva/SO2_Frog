...
#define BUFFER_CIRCULAR_MUTEX_LEITORE TEXT("BUFFER_CIRCULAR_MUTEX_LEITORE")
...
#define FILE_MAPPING_THREAD_ROADS TEXT("SO2_MAP_OLA")

#define THREAD_ROADS_MUTEX TEXT("MUTEX_ROADS")

#define THREAD_ROADS_EVENT TEXT("EVENT_ROADS")

#define INITIAL_EVENT TEXT("INITIAL EVENT")
