...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdShow) {
	...
	int terminar = 0; // para acabar com tudo
		...
		BOOL ret;
		DWORD n;
	    GameData* AllGameData = (GameData*)malloc(sizeof(GameData));
...
// ============================================================================
	...
	wcApp.hbrBackground = CreateSolidBrush(RGB(255, 100, 100));
...
LRESULT CALLBACK TrataEventos(HWND hWnd, UINT messg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CLOSE:
		...
		if (MessageBox(hWnd, TEXT("Sure you want to get out?"), TEXT("Leaving?"), MB_OKCANCEL) == 1)
			DestroyWindow(hWnd);
		break;
